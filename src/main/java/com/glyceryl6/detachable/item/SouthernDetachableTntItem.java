...
public class SouthernDetachableTntItem extends AbstractDetachableTntItem {

    public SouthernDetachableTntItem(Block block, Properties properties) {
    ...
    protected BlockState getPlacementState(BlockPlaceContext context) {
        if (this.getRegistryName() != null) {
            ...
            BlockState state = DetachableTNT.SOUTH_DETACHABLE_TNT.get().defaultBlockState();
            state = state.setValue(SouthernDetachableTntBlock.LEVEL, level);
            return state;
        } else {
            return null;
        }
