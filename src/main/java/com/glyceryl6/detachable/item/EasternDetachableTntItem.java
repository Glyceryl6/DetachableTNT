...
public class EasternDetachableTntItem extends AbstractDetachableTntItem {

    public EasternDetachableTntItem(Block block, Properties properties) {
    ...
    protected BlockState getPlacementState(BlockPlaceContext context) {
        if (this.getRegistryName() != null) {
            ...
            BlockState state = DetachableTNT.EAST_DETACHABLE_TNT.get().defaultBlockState();
            state = state.setValue(EasternDetachableTntBlock.LEVEL, level);
            return state;
        } else {
            return null;
        }
